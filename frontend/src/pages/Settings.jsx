            ...
            <div className="min-h-screen bg-[#0b0e14] p-8 pb-32">
                <header className="flex items-center gap-6 mb-16">
                    ...
                    <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
                        <h1 className="text-4xl font-black text-white tracking-tight mb-2 uppercase italic">Account <span className="text-blue-500">Settings</span></h1>
                        <p className="text-slate-500 font-bold tracking-tight italic">Manage your profile details, password, and preferences here.</p>
                    </motion.div>
                </header>
                    ...
                    <div className="lg:col-span-2 space-y-12">
                        <Card className="bg-[#161b2a] border border-slate-800 rounded-[3rem] p-12 shadow-2xl relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-4 mb-12">
                                ...
                                <h3 className="text-2xl font-black text-white italic tracking-tighter uppercase">Profile Details</h3>
                            </div>
                        ...
                        <Card className="bg-[#161b2a] border border-slate-800 rounded-[3rem] p-12 shadow-2xl relative overflow-hidden">
                            <div className="flex items-center gap-4 mb-12">
                                ...
                                <h3 className="text-2xl font-black text-white italic tracking-tighter uppercase">Password Settings</h3>
                            </div>
                        ...
                        <Card className="bg-[#161b2a] border border-slate-800 rounded-[3rem] p-10">
                            ...
                            <div className="space-y-4">
                                <button className="flex items-center justify-between w-full p-6 bg-[#0b0e14] border border-slate-800 rounded-[2rem] group hover:border-blue-500/30 transition-all">
                                    <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest group-hover:text-white">Export Activity Log</span>
                                ...
                                >
                                    <span className="text-[10px] font-black text-red-500 uppercase tracking-widest group-hover:text-white">Log Out</span>
